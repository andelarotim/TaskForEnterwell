		...
		*/
		...
		if ( ! is_admin() ) {
			...
			*/
			...
			gutentor/e3
			*/
			if ( gutentor_has_block( 'gutentor/counter-box' ) || gutentor_has_block( 'gutentor/e3' ) ||
				gutentor_has_block( 'gutentor/progress-bar' ) || gutentor_has_block( 'gutentor/e9' ) ) {
	...
	public function block_editor_assets() { // phpcs:ignore
		...
		wp_localize_script(
			...
			array(
				...
				'is_templateburg_active'          => gutentor_is_templateburg_active(),
				'edd'                             => array(
