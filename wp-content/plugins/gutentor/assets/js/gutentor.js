(function($) {
    ...
    * */
    ...
    function gApi(gAB, gParam, gAppend = false) {
        ...
        $.ajax({
            ...
            if (max_num_pages <= paged) {
                ...
                gAB.find('.gutentor-post-footer a.gutentor-button').addClass('gutentor-disabled');
                ...
                /*for load more disabled class*/
                gAB.find('.gutentor-post-footer a.gutentor-button').removeClass('gutentor-disabled');
            }
    ...
    gDocument.on('click', '.gutentor-filter-navigation .gutentor-filter-item>a', function(e) {
        ...
        gAB.find('.gutentor-post-footer a.gutentor-button').removeAttr('data-gpage');
    ...
    gDocument.ready(function() {
        ...
        $('.gutentor-post-footer a.gutentor-button').each(function() {
            let gThis = $(this),
                gAB = gThis.closest('.gutentor-advanced-post-module');
